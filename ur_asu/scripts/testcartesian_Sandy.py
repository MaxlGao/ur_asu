...
# from ur_asu.custom_libraries.actionlibrariesmax import insert_usb  # <-- your function here
...
class JTCClient(Node):
    def __init__(self):
        ...
        # Define poses
        pre_insertion_pose = ([-0.2385, -0.665, 0.1685], [0, 180, 0])
        insertion_pose = ([-0.2385, -0.6775, 0.1685], [0, 180, 0])

        segment_duration = 6
        self.trajectories = {
            "traj0": move(pre_insertion_pose[0], pre_insertion_pose[1], 4),
            "traj1": move(insertion_pose[0], insertion_pose[1], 4)
        }
